// Less time left so, no comments here as it will take a lot of time. Please try to understand yourself or ask on discussion forum 
//of Aristok
! function(e, t) {
...

{
    ...
    class Entry {
        constructor(el) {
            ...
            this.DOM.title = {
                word: this.DOM.el.querySelector('.changing-text')
            };
    ...
    let current = -1;
    let allentries = [];
    const sections = Array.from(document.querySelectorAll('.main-text'));
